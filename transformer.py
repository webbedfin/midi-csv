...
root_prompt = (
    ...
    "I'm going to want you to analyze a CSV representations of a MIDI file."
    "Convert this information into a timeline to base further musical analysis on."
    ...
    "lack thereof). From your expansive knowledge of various music theoretical systems look"
    ...
    "baroque, classical, romantic, high romantic, impressionism, expressionism, post-impressionisn, ragtime, blues,"
...
class Transformer:
    ...
    def claude_process(self, csv_content, note_counts, chord_counts):
        ...
        message = client.messages.create(
            ...
            temperature=0.0,
            messages=[
                {"role": "user", "content": root_prompt + csv_content}
                #{"role": "user","content": "Here is part 1 of 2 of the CSV-formatted MIDI data: " + csv_content}
            ]
        )
